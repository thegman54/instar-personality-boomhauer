"""
personality_boomhauer_read — retrieve personality data across all four stores.
...
@register_tool
class PersonalityBoomhauerReadTool(BaseTool):
    """Load Boomhauer personality traits, quotes, lexicon, and reactions."""

    @property
    def name(self) -> str:
        return "personality_boomhauer_read"

    @property
    def description(self) -> str:
        return (
            "Load Boomhauer personality data for the given categories. "
    ...
    async def execute(
        ...
        **kwargs,
        ...
        log.info("personality_boomhauer_read",
        ...
        try:
            ...
            try:
                ...
                await log_tool_activity(
                    tool_name="personality_boomhauer_read",
            ...
            log.error("personality_boomhauer_read_error", error=str(e))
