-- Personality Boomhauer: Core traits table
...
CREATE TABLE IF NOT EXISTS personality_boomhauer_traits (
...
CREATE INDEX IF NOT EXISTS idx_pb_traits_profile_cat
    ON personality_boomhauer_traits(profile_slug, category);
CREATE INDEX IF NOT EXISTS idx_pb_traits_profile_layer
    ON personality_boomhauer_traits(profile_slug, layer);
CREATE INDEX IF NOT EXISTS idx_pb_traits_profile_weight
    ON personality_boomhauer_traits(profile_slug, weight DESC);
CREATE INDEX IF NOT EXISTS idx_pb_traits_tags
    ON personality_boomhauer_traits USING GIN(tags);
CREATE INDEX IF NOT EXISTS idx_pb_traits_examples
    ON personality_boomhauer_traits USING GIN(examples);
