-- Personality Boomhauer: Lexicon table
-- Vocabulary fingerprint — words/phrases to favor, avoid, or use situationally.

CREATE TABLE IF NOT EXISTS personality_boomhauer_lexicon (
...
CREATE INDEX IF NOT EXISTS idx_pb_lexicon_profile
    ON personality_boomhauer_lexicon(profile_slug);
CREATE INDEX IF NOT EXISTS idx_pb_lexicon_type
    ON personality_boomhauer_lexicon(profile_slug, usage_type);
CREATE INDEX IF NOT EXISTS idx_pb_lexicon_freq
    ON personality_boomhauer_lexicon(profile_slug, frequency);
