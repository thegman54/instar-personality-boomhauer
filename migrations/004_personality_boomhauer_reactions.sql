-- Personality Boomhauer: Reactions table
-- Trigger → response pattern mappings for contextual behavior.

CREATE TABLE IF NOT EXISTS personality_boomhauer_reactions (
...
CREATE INDEX IF NOT EXISTS idx_pb_reactions_profile
    ON personality_boomhauer_reactions(profile_slug);
CREATE INDEX IF NOT EXISTS idx_pb_reactions_trigger
    ON personality_boomhauer_reactions(profile_slug, trigger_type);
CREATE INDEX IF NOT EXISTS idx_pb_reactions_intensity
    ON personality_boomhauer_reactions(profile_slug, intensity);
CREATE INDEX IF NOT EXISTS idx_pb_reactions_tags
    ON personality_boomhauer_reactions USING GIN(tags);
